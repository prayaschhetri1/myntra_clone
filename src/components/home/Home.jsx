  ...
  return (
    <div className={styles.container}>
      ...
      <img
        ...
        alt=""
      />
      <div className={styles.five_products_category}>
        <div className={styles.five_first}>
          {category.cat1.map((prod, index) => {
            return <img key={index} src={prod.image} alt="" />;
          })}
        </div>

        <div className={styles.five_second}>
          {category.cat2.map((prod, index) => {
            return <img key={index} src={prod.image} alt="" />;
          })}
        </div>
      </div>
